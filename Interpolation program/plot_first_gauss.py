...
def plot_first_gauss(prefix="first_gauss_", folder="."):
    METRIC_W = 0.42
    VALUE_W  = 0.75
    ...
    basis_name = "Chebyshev polynomials of the first kind"
    node_set_name = "Chebyshev nodes of the first kind"
    ...
    ax.scatter(xn, yn, s=NODE_SIZE, label="Chebyshev nodes of the first kind")
...
if __name__ == "__main__":
    plot_first_gauss(prefix="first_gauss_", folder=SCRIPT_DIR)