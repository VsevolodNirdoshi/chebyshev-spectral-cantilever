...
def plot_first_lobatto(prefix="first_lobatto_", folder="."):
    METRIC_W = 0.42
    VALUE_W  = 0.75
    ...
    ax.set_title("Chebyshev nodes of the second kind")
...
if __name__ == "__main__":
    plot_first_lobatto(prefix="first_lobatto_", folder=SCRIPT_DIR)